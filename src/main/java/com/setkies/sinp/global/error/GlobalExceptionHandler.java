...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(SnipException.class)
    public ResponseEntity<ErrorResponse> handleGlobal(SnipException e) {
    ...
    public ResponseEntity<?> feignException(BindException e) {
        Map<String, String> errorMap = new HashMap<>();
